...
# 2 "<built-in>" 2
# 1 "sm_MenuConfiguration_MC50.c" 2
...
# 3 "sm_MenuConfiguration_MC50.c" 2
...
# 4 "sm_MenuConfiguration_MC50.c" 2
...
# 5 "sm_MenuConfiguration_MC50.c" 2
...
# 7 "sm_MenuConfiguration_MC50.c" 2
...
# 9 "sm_MenuConfiguration_MC50.c" 2
...
# 10 "sm_MenuConfiguration_MC50.c" 2
...
# 13 "sm_MenuConfiguration_MC50.c" 2
...
# 15 "sm_MenuConfiguration_MC50.c" 2
...
static _Bool firstselectflag=1;
    ...
    switch((sm_state_Menu_t) psm->current_state)
    {
        case st_MainMenu:
        {
            if(var_sys.ProgrammingDistanceIs==TypeProgrammingModeFull)
            {
                ...
                if (setValueToEdit(menu_st.actualMenu,menu_st.parameterSelected)) {
                     ...
                     SetSegmentValueIntermitentMain(edit_Param.tempValue/10, edit_Param.tempValue-((edit_Param.tempValue/10)*10),(1000/50));
                }
            }
            ...
            else if (button_struct.current==0x00)
            {
            ...
            else if (button_struct.current==0x17)
            {
                ts_system.timeoutMenu=((1000/50)*5) ;
                menu_st.parameterSelected++;
            ...
            else if( menu_st.actualMenu<S_Menu )
            {
                ...
                else if((ts_system.timeoutMenu<=0||button_struct.current==0x00) && menu_st.actualMenu<=E_Menu)
                {
                ...
                else if(ts_system.timeoutMenu<=0||button_struct.current==0x00)
                {
        ...
        case st_SaveParameter:
        {
            if (ts_system.timeSinalizationDigit<=0)
            {
                ...
                if((menu_st.actualMenu==E_Menu && menu_st.parameterSelected==8)||(edit_Param.Value==(unsigned char*)&var_sys_NVM.TypeofMotor))
                {
        ...
        case st_Counter:
        {
            if(ts_system.timeoutMenu<=0)
            {
                ...
                else
                {
                    ...
                    SetSegmentValueIntermitentMain(edit_Param.tempValue/10, edit_Param.tempValue-((edit_Param.tempValue/10)*10),( 500/50));
                }
            }
        }
        break;
...
void load_New_Menu(menuLists_en Menu){
    ...
    if(Menu==Del_Menu)
    {
        SetSegmentValueIntermitentMain(menu_st.menuList[ menu_st.parameterSelected].value_display1, menu_st.menuList[ menu_st.parameterSelected].value_display2,( 500/50));
    }
    else
    {
        SetSegmentValueMain(menu_st.menuList[ menu_st.parameterSelected].value_display1, menu_st.menuList[ menu_st.parameterSelected].value_display2);
        ...
        case E_Menu:
        {
            ...
            switch (ParameterSelected)
            {
                ...
                case 7:
                {
                    ...
                    auxCounter=10000;
                    ts_system.timeBetweenSaveCounters=0;
...
void controlSelectRemote(void) {
    ...
    char validSerial;
    if(ts_system.timeoutMenu<=0 || button_struct.current==0x00)
    {
        sm_send_event(&main_stateMachine, ev_goto_StandBy);
        sm_send_event(&menuConfiguration_stateMachine, ev_CancelEdition);
    ...
    else if (button_struct.current==0x00 && edit_Param.Max!=0)
    {
        ts_system.timeoutMenu=((1000/50)*5) ;
        if(edit_Param.tempValue<=edit_Param.Min)
        {
        ...
        {
            SetSegmentValueIntermitentMain((edit_Param.tempValue-edit_Param.tempValue%10)/10, edit_Param.tempValue%10,(1000/50));
        }
        else
        {
    ...
    else if (button_struct.current==0x17 && edit_Param.Max!=0)
    {
        ts_system.timeoutMenu=((1000/50)*5) ;
        edit_Param.tempValue++;
        if(edit_Param.tempValue>edit_Param.Max)
    ...
    else if(edit_Param.Max>99 &&edit_Param.tempValue>99 )
    {
        if(menu_st.parameterSelected==0)
        {
    ...
    else if(temp!=0xff&&(temp==0||temp==1|| temp ==2 || temp ==4 || temp==8))
    {
        char pos;
        ...
        if(validSerial==0&&(typeRemote==Keeloq_RollingCode || (var_sys_NVM.OnlyRollingCode==NO)))
        {
            ...
            var_sys.ProgrammingDistanceIs=NoCMD;
            ts_system.timeSinalizationDigit=(1000/50)*2;
            SetSegmentValueIntermitentMain((edit_Param.tempValue-edit_Param.tempValue%10)/10, edit_Param.tempValue%10,( 200/50));
...
void controlLearnDigit(void)
{
    if(ts_system.timeSinalizationDigit<=0 )
    {
        ts_system.timeSinalizationDigit=( 100/50);
