...
# 10 "sm_ControlLearning_MC50.c" 2
...
# 12 "sm_ControlLearning_MC50.c" 2
...
# 13 "sm_ControlLearning_MC50.c" 2
...
# 14 "sm_ControlLearning_MC50.c" 2
...
# 16 "sm_ControlLearning_MC50.c" 2
    ...
    switch((sm_state_ControlGate_t) psm->current_state)
    {
        case st_InitLearning:
        {
            if(var_sys.FimCurso_CloseIsEnabled==YES)
            {
                ...
                clearLearningValue();
                 if ((var_sys_NVM.decelarationSensivity != 0) && (var_sys.programinAutomatic == 0))
                         {
                ts_system.TimeLearningDecelaration=(1000/50)*15;
                ts_system.TimeWaitToGetCurrent=(1000/50)*6;
                ts_system.TimeWaitReleCapacitor = (1000/50);
                ...
                ts_system.TimeWaitToGetCurrent=(1000/50)*4;
                ts_system.TimeWaitReleCapacitor = (1000/50);
                control_limit_switch = 0;
                }
        ...
        case st_WaitLearnigOpen:
        {
            ...
            if(ts_system.TimeWaitToNextState<=0)
            {
                ...
                sm_send_event(&controlLearning_stateMachine, ev_GateOpened);
                var_sys.StateMotor=InClose;
                ts_system.TimeLearningDecelaration=(1000/50)*5;
                ts_system.TimeWaitToGetCurrent=(1000/50)*5;
                ts_system.TimeWaitReleCapacitor = (1000/50);
                control_limit_switch = 0;
            }
            }
        ...
        case st_WaitLearnigClose:
        {
            if((var_sys.FimCurso_CloseIsEnabled==YES)||(control_limit_switch == 1))
            {
                ...
                if(ts_system.TimeWaitToNextState<=0)
                {
                    ...
                    var_sys.StateMotor=InOpenFull;
                    var_sys.LearningDecelaration=NO;
                    ts_system.TimeWaitToGetCurrent=(1000/50)*3;
                    ts_system.TimeWaitReleCapacitor = (1000/50);
                    control_limit_switch = 0;
