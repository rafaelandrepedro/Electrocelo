...
# 131 "./mcc_generated_files/mcc.h"
void WWDT_SoftEnable(void);
# 143 "./mcc_generated_files/mcc.h"
void WWDT_SoftDisable(void);
# 156 "./mcc_generated_files/mcc.h"
void WWDT_TimerClear(void);
# 169 "./mcc_generated_files/mcc.h"
_Bool WWDT_TimeOutStatusGet(void);
# 183 "./mcc_generated_files/mcc.h"
_Bool WWDT_WindowViolationStatusGet(void);
# 8 "controlMemory_MC50.c" 2
...
void I2C1_WriteNBytes(i2c1_address_t address, uint16_t reg, void* data, size_t len);
...
TypeCMD validateRemoteSerialNumber(unsigned long serial, StateEnum VerifyOnlySerial, char* position){
    ...
    for (i=0;i<var_sys_NVM.positionRemotesFull;i++)
    {
        if(i%4==0)
        {
            ...
            i2c_readDataBlock(0x50, (uint16_t)(0x0200 + (i * 4)),(char*)memoryTEMP, 16);
        }
    ...
    for (i=0;i<var_sys_NVM.positionRemotesWalk;i++)
    {
        ...
        {
            j=0;
            i2c_readDataBlock(0x50, (uint16_t)(0x0500 + (i * 4)),(char*)memoryTEMP, 16);
        }
...
void saveNewSerial(char cmdType,unsigned long tempSerial, char position)
{
    if(cmdType==0)
    {
        ...
        i2c_writeNBytes(0x50, (uint16_t)(0x0200 + (position * 4)), (char*)&tempSerial, 4);
    }
    else
    {

        i2c_writeNBytes(0x50, (uint16_t)(0x0500 + (position * 4)), (char*)&tempSerial, 4);
    }
}
...
void loadNVM_VarSystem(void)
{
    if((I2C1_Read1ByteRegister(0x50, 0) == 0xFF) && (I2C1_Read1ByteRegister(0x50, 16) == 0xFF))
    {
    ...
    i2c_readDataBlock(0x50, (uint16_t)(pageMemoryP * 16),(char*)&var_sys_NVM,16);
    i2c_readDataBlock(0x50, (uint16_t)(pageMemoryE * 16),(char*)&var_sys_NVM.homemPresente, 16);
    i2c_readDataBlock(0x50, (uint16_t)(pageMemoryCounters * 16),(char*)&var_sys_NVM.positionRemotesFull,16);
    i2c_readDataBlock(0x50, (uint16_t)(pageMemoryLearningVars * 16),(char*)&var_sys_NVM.learningCurrentNormalClose, 16);
...
void SaveNVM_VarSystem(unsigned char page)
{
    ...
    point=point+tempAdd;
   i2c_writeNBytes(0x50, tempAdd, point, 16);
}
...
void ResetDefaultMemory(unsigned char type)
{
    ...
    var_sys_NVM.decelarationOpen = 3;
    var_sys_NVM.motorPower = 9;
    var_sys_NVM.decelarationClose = 3;
    var_sys_NVM.photoCellIsON = 0;
    var_sys_NVM.photoCellInOpen = 0;
    var_sys_NVM.securityBandIsON = 0 ;
    var_sys_NVM.securityBandType = 1;
    var_sys_NVM.securityBandInOpen = 0;
    var_sys_NVM.flashLightMode = 0;
    var_sys_NVM.programmingDistance = 0;
    var_sys_NVM.decelarationSensivity = 0;
    var_sys_NVM.homemPresente = 0;
    var_sys_NVM.autoTimeWalkClose = 0;
    var_sys_NVM.ligthTime = 3;
    var_sys_NVM.folow_me = 0;
    var_sys_NVM.electricBrake = 0;
    var_sys_NVM.autoTimeWalkClose = 0;
    var_sys_NVM.Direction_motor = 1 ;


    if (type == SC){

        var_sys_NVM.motorSensitivity = 0;
        var_sys_NVM.logicDigital = 0;
        var_sys_NVM.Stopboton = 0;
        var_sys_NVM.autoTimeFullClose = 0;
        var_sys_NVM.operationMode = 0;
        var_sys_NVM.velocityDecelaration = 5;
        var_sys_NVM.flashRGBMode = 3;
        var_sys_NVM.softstop = 0;
        var_sys_NVM.softStart = 0;
        var_sys_NVM.walkTime = 10;

    }
    else if (type == SE){
        var_sys_NVM.decelarationClose = 4;
        var_sys_NVM.decelarationOpen = 4;
        var_sys_NVM.motorSensitivity = 4;
        var_sys_NVM.logicDigital = 1;
        var_sys_NVM.Stopboton = 1;
        var_sys_NVM.autoTimeFullClose = 0;
        var_sys_NVM.operationMode = 0;
        var_sys_NVM.velocityDecelaration = 5;
        var_sys_NVM.flashRGBMode = 3;
        var_sys_NVM.softstop = 0;
        var_sys_NVM.softStart = 5;
        var_sys_NVM.walkTime = 0;
        var_sys_NVM.Direction_motor = 0 ;

    }
    else if (type == br){
        var_sys_NVM.decelarationClose = 6;
        var_sys_NVM.decelarationOpen = 2;
        var_sys_NVM.motorSensitivity = 0;
        var_sys_NVM.logicDigital = 0;
        var_sys_NVM.Stopboton = 0;
        var_sys_NVM.autoTimeFullClose = 0;
        var_sys_NVM.operationMode = 2;
        var_sys_NVM.velocityDecelaration = 5;
        var_sys_NVM.flashRGBMode = 1;
        var_sys_NVM.softstop = 5;
        var_sys_NVM.softStart = 0;
        var_sys_NVM.walkTime = 0;
    ...
    if ((PORTAbits.RA2 == 0) && (PORTAbits.RA1 == 0) && (PORTBbits.RB0 == 0)&&(PORTAbits.RA5==0)){
...
void ControlCounterMoves(void)
{
    ...
    {
       ts_system.timeBetweenSaveCounters=((1000/50)*60)*5;
